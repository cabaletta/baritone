...
public class CalculationContext {
    ...
    public CalculationContext(IBaritone baritone, boolean forUseOnAnotherThread) {
        ...
        this.hasWaterBucket = Baritone.settings().allowWaterBucketFall.value && PlayerInventory.isHotbar(player.inventory.getSlotFor(STACK_BUCKET_WATER)) && world.func_234923_W_() != World.field_234919_h_;
